  ...
  return (
    <PageLayout bodyClassName="test-variant-page test-page-with-bg">
        ...
        <div className="fixed inset-0 bg-white z-9999 flex flex-col items-center justify-center p-6 text-center">
          <div className="max-w-md space-y-6">
            ...
            <p className="text-lg text-gray-600">
              Доступ к конструктору ограничен администратором. Если вы считаете,
              что это ошибка, обратитесь в поддержку к админу по почте{' '}
      ...
      <head>
        ...
        <meta
          name="description"
          content="Еженедельный тренировочный вариант ЕГЭ по литературе."
        />
      </head>
