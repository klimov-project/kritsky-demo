    ...
    <PageLayout bodyClassName="test-variant-page test-page-with-bg">
      ...
      {user?.isBlocked && (
        <NewTestBlockedOverlay
          supportEmail={
            process.env.NEXT_PUBLIC_SUPPORT_EMAIL || 'admin@kritsky.local'
          }
        />
      )}
      ...
      >
        <div className="space-y-2 text-sm">
          <p>
            {limitModalMessage || 'Скачивание или печать сейчас недоступны.'}
          </p>
      ...
      <div className={styles.pageContainer}>
        <div
          className={`print-area test-content-surface min-w-0 variant-uniform ${styles.surface}`}
        >
          {shouldShowVariantSkeleton && <TestVariantSkeleton />}
          ...
          {!isKnowledgeBaseLoading &&
            !knowledgeBaseError &&
            (!works.length || !poets.length) && (
              <div className="rounded-xl border border-gray-200 bg-white p-6 text-sm">
                База знаний в БД пока пуста. Добавьте материалы в разделе
                `/admin/materials` и сохраните их в БД.
              </div>
            )}
          ...
          {!isKnowledgeBaseLoading &&
            ...
            variant && (
              <div className="space-y-8 scene-animate" key={animationKey}>
                <div className={styles.variantHeader}>
                  ...
                  <div className={`${styles.topGrid} no-print`}>
                    <div className={styles.leftCards}>
                      <div
                        className={`${styles.leftCard} ${styles.leftCardMain}`}
                      >
                        Вариант 1
                      </div>
                      <div
                        className={`${styles.leftCard} ${styles.leftCardSub}`}
                      >
                        Часть 1
                      </div>
                    </div>
                    ...
                    <div className={styles.filtersWrap}>
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                        ...
                        {selectedWork && (
                          <SelectField
                            ...
                            options={getExcerptChapters(selectedWork).map(
                              (ch, i) => ({
                                value: ch,
                                label: `${i + 1}. ${ch}`,
                              }),
                        ...
                        <div className="relative">
                          <SelectField
                            ...
                            onChange={(val) => {
                              if (!isPro)
                                openPaywall(
                                  'Выбор отрывка доступен только по подписке.',
                                );
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        >
                          ...
                          {!user && (
                            <IoLockClosedOutline className="opacity-50" />
                          )}
                  ...
                  <div className="no-print mb-3 p-2 rounded border border-orange-200 bg-orange-50 text-xs text-orange-800">
                    ...
                    <div className="flex flex-wrap gap-1">
                      {Object.entries(weeklyPins).map(([key, id]) => (
                        <span
                          key={key}
                          className="inline-flex items-center gap-0.5 bg-white border border-orange-200 rounded px-1.5 py-0.5"
                        >
                ...
                {isAdmin && (
                  <div className="no-print mt-2 mb-1 text-xs text-gray-500 flex flex-wrap items-center gap-1">
                    ...
                    <AdminIdBadge
                      id={variant.work.id}
                      extra={
                        variant.work.authorId
                          ? `author:${variant.work.authorId}`
                          : undefined
                      }
                    />
                    <span>| Отрывок</span>
                ...
                <div
                  className={`${styles.introCard} mt-4 mb-8 text-lg leading-relaxed`}
                >
                  <RichTextBlock
                ...
                <div className={`${styles.textCard} space-y-4`}>
                  {getTextColumnsCount(variant.excerpt.textColumns) === 2 &&
                  (variant.excerpt.textSecondColumn || '').trim() ? (
                      ...
                      <div className="no-print flex flex-wrap justify-end gap-2">
                        ...
                        >
                          {refreshLoadingByBlock.block1 ? (
                            ...
                            !isPro && <IoLockClosedOutline className="mr-1" />
                          )}
                          Предыдущая сцена
                        </Button>
                        <Button
                ...
                <div
                  className={`print-page-break ${styles.introCard} mt-8 mb-6 text-base leading-relaxed`}
                >
                  <RichTextBlock
                    value={
                      knowledgeBaseSettings.variantTexts.part1QuestionsIntro
                    }
                ...
                <div className={styles.taskStack}>
                  <div className="flex items-start gap-3">
                    <QuestionActions
                      ...
                      disableRefresh={
                        isBusyWithFullOperations || refreshDisabledByTask.task1
                      }
                    ...
                    <div
                      className={`flex-1 space-y-2 ${
                        collapsedTasks.has('task1') ? 'hidden print:block' : ''
                      }`}
                    >
                      <div className="no-print flex flex-wrap gap-4 text-xs">
                        <Checkbox
                          ...
                          onChange={(event) =>
                            setTask1Filters((prev: Task1Filters) => ({
                              ...prev,
                        ...
                        <div className="flex-1">
                          ...
                          {isAdmin && (
                            <AdminTaskMeta
                              ...
                              taskKey="task1"
                              pinned={
                                weeklyPins['task1'] !== undefined &&
                                weeklyPins['task1'] ===
                                  String(variant.task1?.id ?? '')
                              }
                              pinConflict={getPinConflict(
                                'task1',
                                variant.task1,
                              )}
                              onPin={() =>
                              ...
                              onUnpin={() => void handleUnpinTask('task1')}
                              onSelect={() => openSelectModal('task1')}
                            />
                          )}
                        </div>
                      </div>
                  ...
                  <div className="flex items-start gap-3">
                    <QuestionActions
                      ...
                      disableRefresh={
                        isBusyWithFullOperations || refreshLoadingByTask.task2
                      }
                    ...
                    <div
                      className={`flex-1 text-sm space-y-3 ${
                        collapsedTasks.has('task2') ? 'hidden print:block' : ''
                      }`}
                    >
                      <div className="flex items-start gap-3 variant-copy">
                        ...
                        <div className="flex-1">
                          ...
                          {isAdmin && (
                            <AdminTaskMeta
                              ...
                              taskKey="task2"
                              pinned={
                                weeklyPins['task2'] !== undefined &&
                                weeklyPins['task2'] ===
                                  String(variant.task2?.id ?? '')
                              }
                              pinConflict={getPinConflict(
                                'task2',
                                variant.task2,
                              ...
                              onUnpin={() => void handleUnpinTask('task2')}
                              onSelect={() => openSelectModal('task2')}
                            />
                          )}
                        </div>
                      </div>
                      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div className="space-y-3">
                          <div className="text-center text-[28px] leading-none tracking-wide">
                            {variant.task2?.leftLabel?.toUpperCase() ||
                              'ПЕРСОНАЖИ'}
                          </div>
                          ...
                          <div
                            ...
                            style={
                              {
                                '--columns': task2Columns,
                              } as React.CSSProperties
                            }
                          >
                            {Array.from({ length: task2Columns }).map(
                              (_, index) => (
                                <div
                                  key={`task2-head-${index}`}
                                  className="new-test-answer-cell text-2xl"
                                >
                                  {RUSSIAN_LETTERS[index] || `${index + 1}`}
                                </div>
                              ),
                            ...
                            {Array.from({ length: task2Columns }).map(
                              (_, index) => (
                                <div
                                  key={`task2-value-${index}`}
                                  className="new-test-answer-cell"
                                />
                              ),
                            )}
                          </div>
                        ...
                        <div className="space-y-3">
                          <div className="text-center text-[28px] leading-none tracking-wide">
                            {variant.task2?.rightLabel?.toUpperCase() ||
                              'СВОЙСТВО'}
                          </div>
                          <div className="space-y-1 text-left">
                            {task2RightOptions.map((option, index) => {
                              const optionId =
                                variant?.task2?.shuffledRightOptionIds?.[
                                  index
                                ] || '';
                              return (
                                <div
                      ...
                      {checkedAnswers.has('task2') && (
                        <div className="text-xs opacity-80">
                          Ответ:{' '}
                          {getTask2AnswerMap(variant.task2, RUSSIAN_LETTERS)}
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    <QuestionActions
                      ...
                      disableRefresh={
                        isBusyWithFullOperations || refreshDisabledByTask.task3
                      }
                    ...
                    <div
                      className={`flex-1 space-y-2 ${
                        collapsedTasks.has('task3') ? 'hidden print:block' : ''
                      }`}
                    >
                      <div className="flex items-start gap-3 variant-copy">
                        ...
                        <div className="flex-1">
                          ...
                          {isAdmin && (
                            <AdminTaskMeta
                              ...
                              taskKey="task3"
                              pinned={
                                weeklyPins['task3'] !== undefined &&
                                weeklyPins['task3'] ===
                                  String(variant.task3?.id ?? '')
                              }
                              pinConflict={getPinConflict(
                                'task3',
                                variant.task3,
                              ...
                              onUnpin={() => void handleUnpinTask('task3')}
                              onSelect={() => openSelectModal('task3')}
                            />
                          )}
                        </div>
                      </div>
                      <div className="text-sm variant-copy">
                        <RichTextBlock
                          value={variant.task3?.part1}
                          fallback="—"
                          as="span"
                        />{' '}
                        <RichTextBlock
                          value={variant.task3?.part2}
                          fallback="—"
                          as="span"
                        />
                      </div>
                      ...
                      {checkedAnswers.has('task3') && (
                        <div className="text-xs opacity-80">
                          Ответ: {variant.task3?.answer1 || '—'} /{' '}
                          {variant.task3?.answer2 || '—'}
                        </div>
                      )}
                    </div>
                  </div>
                ...
                <div
                  className={`print-page-break ${styles.introCard} text-base leading-relaxed`}
                >
                  <RichTextBlock
                ...
                <div className="space-y-[30px]">
                  <div className="flex items-start gap-3">
                    ...
                    />
                    <div
                      className={`text-sm flex-1 space-y-1 variant-copy ${
                        collapsedTasks.has('task4_1')
                          ? 'hidden print:block'
                          : ''
                      }`}
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          {isAdmin && (
                            <AdminTaskMeta
                              task={variant.task4_1}
                              taskKey="task4_1"
                              pinned={
                                weeklyPins['task4_1'] !== undefined &&
                                weeklyPins['task4_1'] ===
                                  String(variant.task4_1?.id ?? '')
                              }
                              pinConflict={getPinConflict(
                                'task4_1',
                                variant.task4_1,
                              ...
                              onUnpin={() => void handleUnpinTask('task4_1')}
                              onSelect={() => openSelectModal('task4_1')}
                            />
                          )}
                        </div>
                      </div>
                    ...
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          {isAdmin && (
                            <AdminTaskMeta
                              task={variant.task4_2}
                              taskKey="task4_2"
                              pinned={
                                weeklyPins['task4_2'] !== undefined &&
                                weeklyPins['task4_2'] ===
                                  String(variant.task4_2?.id ?? '')
                              }
                              pinConflict={getPinConflict(
                                'task4_2',
                                variant.task4_2,
                              ...
                              onUnpin={() => void handleUnpinTask('task4_2')}
                              onSelect={() => openSelectModal('task4_2')}
                            />
                          )}
                        </div>
                      </div>
                ...
                <div className="flex items-start gap-3">
                  <QuestionActions
                    ...
                    disableRefresh={
                      isBusyWithFullOperations || refreshDisabledByTask.task5
                    }
                  ...
                  <div
                    className={`text-sm flex-1 space-y-1 variant-copy ${
                      collapsedTasks.has('task5') ? 'hidden print:block' : ''
                    }`}
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        {isAdmin && (
                          <AdminTaskMeta
                            ...
                            taskKey="task5"
                            pinned={
                              weeklyPins['task5'] !== undefined &&
                              weeklyPins['task5'] ===
                                String(variant.task5?.id ?? '')
                            }
                            pinConflict={getPinConflict('task5', variant.task5)}
                            onPin={() =>
                              void handlePinTask(
                                'task5',
                                String(variant.task5?.id ?? ''),
                            ...
                            onUnpin={() => void handleUnpinTask('task5')}
                            onSelect={() => openSelectModal('task5')}
                          />
                        )}
                      </div>
                    </div>
                ...
                <section className="print-part-break space-y-4">
                  <div className={`no-print ${styles.controlPanel}`}>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                      <SelectField
                        ...
                        options={availablePoets.map((poet) => ({
                          value: poet.id,
                          label: poet.name,
                        }))}
                      ...
                      <div className="relative">
                        <SelectField
                          ...
                          onChange={(val) => {
                            if (!isPro)
                              openPaywall(
                                'Выбор стихотворения доступен только по подписке.',
                              );
                            else setSelectedPoemId(val);
                          }}
                          options={availablePoems.map((poem) => ({
                            value: poem.id,
                            label: poem.title,
                          }))}
                  ...
                  {isAdmin && (
                    <div className="no-print text-xs text-gray-500 flex flex-wrap items-center gap-1">
                      ...
                      <AdminIdBadge
                        id={variant.poet?.id}
                        extra={
                          variant.poet?.authorId
                            ? `author:${variant.poet.authorId}`
                            : undefined
                        }
                      />
                  ...
                  <div className="space-y-2">
                    ...
                    {getTextColumnsCount(variant.poem.textColumns) === 2 &&
                    (variant.poem.textSecondColumn || '').trim() ? (
                      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                        <RichTextBlock
                  ...
                  >
                    <RichTextBlock
                      value={
                        knowledgeBaseSettings.variantTexts.part2QuestionsIntro
                      }
                  ...
                  <div className={styles.taskStack}>
                    <div className="flex items-start gap-3">
                      ...
                      />
                      <div
                        className={`flex-1 variant-copy ${
                          collapsedTasks.has('task6')
                            ? 'hidden print:block'
                            : ''
                        }`}
                      >
                          ...
                          <div className="flex-1">
                            ...
                            {isAdmin && (
                              <AdminTaskMeta
                                ...
                                taskKey="task6"
                                pinned={
                                  weeklyPins['task6'] !== undefined &&
                                  weeklyPins['task6'] ===
                                    String(variant.task6?.id ?? '')
                                }
                                pinConflict={getPinConflict(
                                  'task6',
                                  variant.task6,
                                ...
                                onUnpin={() => void handleUnpinTask('task6')}
                                onSelect={() => openSelectModal('task6')}
                              />
                            )}
                          </div>
                        </div>
                        <div className="text-sm mt-2">
                          <RichTextBlock
                            value={variant.task6?.part1}
                            fallback="—"
                            as="span"
                          />{' '}
                          <RichTextBlock
                            value={variant.task6?.part2}
                            fallback="—"
                            as="span"
                          />
                        </div>
                        ...
                        {checkedAnswers.has('task6') && (
                          <div className="text-xs opacity-80 mt-1">
                            Ответ: {variant.task6?.answer1 || '—'} /{' '}
                            {variant.task6?.answer2 || '—'}
                          </div>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      />
                      <div
                        className={`flex-1 text-sm space-y-2 variant-copy ${
                          collapsedTasks.has('task7')
                            ? 'hidden print:block'
                            : ''
                        }`}
                      >
                          ...
                          <div className="flex-1">
                            ...
                            {isAdmin && (
                              <AdminTaskMeta
                                ...
                                taskKey="task7"
                                pinned={
                                  weeklyPins['task7'] !== undefined &&
                                  weeklyPins['task7'] ===
                                    String(variant.task7?.id ?? '')
                                }
                                pinConflict={getPinConflict(
                                  'task7',
                                  variant.task7,
                                ...
                                onUnpin={() => void handleUnpinTask('task7')}
                                onSelect={() => openSelectModal('task7')}
                              />
                            )}
                          </div>
                        </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      >
                          ...
                          <div className="flex-1">
                            ...
                            {isAdmin && (
                              <AdminTaskMeta
                                ...
                                taskKey="task8"
                                pinned={
                                  weeklyPins['task8'] !== undefined &&
                                  weeklyPins['task8'] ===
                                    String(variant.task8?.id ?? '')
                                }
                                pinConflict={getPinConflict(
                                  'task8',
                                  variant.task8,
                                ...
                                onUnpin={() => void handleUnpinTask('task8')}
                                onSelect={() => openSelectModal('task8')}
                              />
                            )}
                          </div>
                        </div>
                        <div className="space-y-1">
                          ...
                          {!(variant.task8Options || []).length && (
                            <div className="opacity-60">
                              Варианты пока не сформированы.
                            </div>
                          )}
                        </div>
                        <div className="text-sm opacity-60">
                  ...
                  <div className="print-page-break space-y-3">
                    ...
                    <CollapsibleInstruction
                      value={
                        knowledgeBaseSettings.variantTexts.part2Task9Criteria
                      }
                      ...
                      >
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            ...
                            {isAdmin && (
                              <AdminTaskMeta
                                task={variant.task9_1}
                                taskKey="task9_1"
                                pinned={
                                  weeklyPins['task9_1'] !== undefined &&
                                  weeklyPins['task9_1'] ===
                                    String(variant.task9_1?.id ?? '')
                                }
                                pinConflict={getPinConflict(
                                  'task9_1',
                                  variant.task9_1,
                                ...
                                onUnpin={() => void handleUnpinTask('task9_1')}
                      ...
                      >
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            ...
                            {isAdmin && (
                              <AdminTaskMeta
                                task={variant.task9_2}
                                taskKey="task9_2"
                                pinned={
                                  weeklyPins['task9_2'] !== undefined &&
                                  weeklyPins['task9_2'] ===
                                    String(variant.task9_2?.id ?? '')
                                }
                                pinConflict={getPinConflict(
                                  'task9_2',
                                  variant.task9_2,
                                ...
                                onUnpin={() => void handleUnpinTask('task9_2')}
                                onSelect={() => openSelectModal('task9_2')}
                              />
                            )}
                          </div>
                        </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      />
                      <div
                        className={`flex-1 text-sm variant-copy ${
                          collapsedTasks.has('task10')
                            ? 'hidden print:block'
                            : ''
                        }`}
                      >
                          ...
                          <div className="flex-1">
                            ...
                            {isAdmin && (
                              <AdminTaskMeta
                                ...
                                taskKey="task10"
                                pinned={
                                  weeklyPins['task10'] !== undefined &&
                                  weeklyPins['task10'] ===
                                    String(variant.task10?.id ?? '')
                                }
                                pinConflict={getPinConflict(
                                  'task10',
                                  variant.task10,
                                ...
                                onUnpin={() => void handleUnpinTask('task10')}
                                onSelect={() => openSelectModal('task10')}
                              />
                            )}
                          </div>
                        </div>
                        {selectedThemeId && (
                          <div className="no-print text-xs opacity-60 mt-1">
                            Текущая тема фильтра: {selectedThemeId}
                          </div>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="flex justify-end">
                      <Button
                        ...
                        onClick={() => {
                          if (!isPro) {
                            openPaywall(
                              'Полное обновление блока 11 доступно только по подписке.',
                            );
                            return;
                          }
                          refreshBlock3();
                  ...
                  <div className={styles.taskStack}>
                    <div className="flex items-start gap-3">
                      <QuestionActions
                        ...
                        disableRefresh={
                          isBusyWithFullOperations ||
                          refreshDisabledByTask.task11_1
                        }
                      ...
                      />
                      <div
                        className={`text-sm flex-1 variant-copy ${
                          collapsedTasks.has('task11_1')
                            ? 'hidden print:block'
                            : ''
                        }`}
                      >
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            <RichTextBlock
                              value={variant.task11_1?.text}
                              fallback="Вопрос 11.1 не задан"
                              className="rich-content text-sm leading-relaxed"
                            />
                            {isAdmin && (
                              <AdminTaskMeta
                                task={variant.task11_1}
                                showRod
                                taskKey="task11_1"
                                pinned={
                                  weeklyPins['task11_1'] !== undefined &&
                                  weeklyPins['task11_1'] ===
                                    String(variant.task11_1?.id ?? '')
                                }
                                pinConflict={getPinConflict(
                                  'task11_1',
                                  variant.task11_1,
                                ...
                                onUnpin={() => void handleUnpinTask('task11_1')}
                                onSelect={() => openSelectModal('task11_1')}
                              />
                            )}
                          </div>
                        </div>
                    ...
                    <div className="flex items-start gap-3">
                      <QuestionActions
                        ...
                        disableRefresh={
                          isBusyWithFullOperations ||
                          refreshDisabledByTask.task11_2
                        }
                      ...
                      >
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            <RichTextBlock
                              value={variant.task11_2?.text}
                              fallback="Вопрос 11.2 не задан"
                              className="rich-content text-sm leading-relaxed"
                            />
                            {isAdmin && (
                              <AdminTaskMeta
                                task={variant.task11_2}
                                showRod
                                taskKey="task11_2"
                                pinned={
                                  weeklyPins['task11_2'] !== undefined &&
                                  weeklyPins['task11_2'] ===
                                    String(variant.task11_2?.id ?? '')
                                }
                                pinConflict={getPinConflict(
                                  'task11_2',
                                  variant.task11_2,
                                ...
                                onUnpin={() => void handleUnpinTask('task11_2')}
                                onSelect={() => openSelectModal('task11_2')}
                              />
                            )}
                          </div>
                        </div>
                    ...
                    <div className="flex items-start gap-3">
                      <QuestionActions
                        ...
                        disableRefresh={
                          isBusyWithFullOperations ||
                          refreshDisabledByTask.task11_3
                        }
                      ...
                      >
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            <RichTextBlock
                              value={variant.task11_3?.text}
                              fallback="Вопрос 11.3 не задан"
                              className="rich-content text-sm leading-relaxed"
                            />
                            {isAdmin && (
                              <AdminTaskMeta
                                task={variant.task11_3}
                                showRod
                                taskKey="task11_3"
                                pinned={
                                  weeklyPins['task11_3'] !== undefined &&
                                  weeklyPins['task11_3'] ===
                                    String(variant.task11_3?.id ?? '')
                                }
                                pinConflict={getPinConflict(
                                  'task11_3',
                                  variant.task11_3,
                                ...
                                onUnpin={() => void handleUnpinTask('task11_3')}
                                onSelect={() => openSelectModal('task11_3')}
                              />
                            )}
                          </div>
                        </div>
                    ...
                    <div className="flex items-start gap-3">
                      <QuestionActions
                        ...
                        disableRefresh={
                          isBusyWithFullOperations ||
                          refreshDisabledByTask.task11_4
                        }
                      ...
                      >
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            <RichTextBlock
                              value={variant.task11_4?.text}
                              fallback="Вопрос 11.4 не задан"
                              className="rich-content text-sm leading-relaxed"
                            />
                            {isAdmin && (
                              <AdminTaskMeta
                                task={variant.task11_4}
                                showRod
                                taskKey="task11_4"
                                pinned={
                                  weeklyPins['task11_4'] !== undefined &&
                                  weeklyPins['task11_4'] ===
                                    String(variant.task11_4?.id ?? '')
                                }
                                pinConflict={getPinConflict(
                                  'task11_4',
                                  variant.task11_4,
                                ...
                                onUnpin={() => void handleUnpinTask('task11_4')}
                                onSelect={() => openSelectModal('task11_4')}
                              />
                            )}
                          </div>
                        </div>
                    ...
                    <div className="flex items-start gap-3">
                      <QuestionActions
                        ...
                        disableRefresh={
                          isBusyWithFullOperations ||
                          refreshDisabledByTask.task11_5
                        }
                      ...
                      >
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            <RichTextBlock
                              value={variant.task11_5?.text}
                              fallback="Вопрос 11.5 не задан"
                              className="rich-content text-sm leading-relaxed"
                            />
                            {isAdmin && (
                              <AdminTaskMeta
                                task={variant.task11_5}
                                showRod
                                taskKey="task11_5"
                                pinned={
                                  weeklyPins['task11_5'] !== undefined &&
                                  weeklyPins['task11_5'] ===
                                    String(variant.task11_5?.id ?? '')
                                }
                                pinConflict={getPinConflict(
                                  'task11_5',
                                  variant.task11_5,
                                ...
                                onUnpin={() => void handleUnpinTask('task11_5')}
                                onSelect={() => openSelectModal('task11_5')}
                              />
                            )}
                          </div>
                        </div>
        ...
        {variant && (
          <div className={`no-print ${styles.bottomActions}`}>
            ...
            <button
              ...
              disabled={isBusyWithFullOperations || isAnyTaskRefreshing}
            >
              {variantGenerationMode === 'selected' ? (
                <IoRefreshOutline className="animate-spin" />
              ) : (
                <IoRefreshOutline />
              )}
